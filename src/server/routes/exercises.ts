...
import { getExerciseById } from '../../shared/exercises.js';
import type { WorkoutEntry } from '../../shared/types.js';
...
router.post('/:id/log', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const result = await logWorkout(googleId, exerciseId as string, entry);
